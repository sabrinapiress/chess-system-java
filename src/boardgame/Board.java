...
public class Board {
	...
	//Removendo a peça do tabuleiro, verificando se a posição existe
	//se a posição for igual a null, retorna null, mas caso não for tranformamos aquela posição em null, assim a mesma ficaria vazia
